            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content p-4">
                    ...
                    <div class="modal-body">
                        ...
                        <form class="form-login"  method="POST" action="<?php url('home/index') ?>">
                        <div class="form-group">
                            <input type="text" name="username" id="email" class="form-control p-0" required
                                style="box-shadow: none;border-radius:0px">
                            <label class="form-control-placeholder p-0" for="name">Username</label>
                        </div>
                        <div class="form-group">
                            <input type="password" name="password" id="password" class="form-control p-0" required
                                style="box-shadow: none;border-radius:0px">
